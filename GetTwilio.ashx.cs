...
namespace GetChat
{
    ...
    public class GetTwilio : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                string Jsonfile = "C:\\Logs\\GetTwilio-JSON.log"; // Update path as needed
            ...
            {
                logfile = "C:\\Logs\\GetTwilio.log"; // Update path as needed
                try
                {
            ...
            for (int i = 0; i < ctr; i++)
            {
                ...
                if (EmailAddress[i] != "" && EmailAddress[i] != "root@yourdomain.com" && EmailAddress[i] != "root@yourdomain2.com" && toProcess)
                {
